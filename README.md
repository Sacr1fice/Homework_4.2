...
1. заполнить поле "Имя" невалидными данными;
2. заполнить поле "Номер телефона" невалидными данными не по шаблону;
3. заполнить поле "Электронная почта" невалидными данными;
...
4. кликнуть по кнопке "Записаться".
##### Ожидаемый результат: сообщение "Обязательные поля", запись на курс не происходит
